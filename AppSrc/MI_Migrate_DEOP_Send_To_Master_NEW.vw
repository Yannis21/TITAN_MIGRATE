        ...
        Procedure OnClick
            ...
            While (Found)
                ...
                If ( (Clients.EXPORTFLAG=1) and ((CN.EXPORTFLAG=1) or (Trim(CN.POLH_RECR)='1')) ) Begin
                    ...
                    String sRecr sCNCode
                    Date dLastCreated
                    Move "" to sRecr
                    Move "" to sCNCode
                    Move "" to dLastCreated
                    Clear BtnOrdH
                    Move CN.CN_CODE to BtnOrdH.CN_CODE
                    Find GE BtnOrdH by Index.3
                    While ((Found) and (BtnOrdH.CN_CODE=CN.CN_CODE))
                        If ((BtnOrdH.DEOP_ACTIVE=0) and (BTNORDH.LOCKED=1)) Begin
                            If (Btnordh.DATE_CREATE>dLastCreated) Begin
                                Move Btnordh.DATE_CREATE    to dLastCreated 
                                Move BtnOrdh.CN_CODE        to sCNCode
                    ...
                    Clear BtnOrdH
                    Move sCNCode    to BtnOrdH.CN_CODE
                    Move sRecr      to BtnOrdH.RECR
                    Find EQ BtnOrdH by Index.3
                    If (Found) Begin
                        Move 1 to isGood
                        ...
                        End // If (isGood) MICN
                    End // If (Found) Begin
                End // If ( (Clients.EXPORTFLAG=1) and ((CN.EXPORTFLAG=1) or (Trim(CN.POLH_RECR)='1')) ) Begin
                Find GT CN.RECNUM
            Loop
            Set Label to sLabel
