// L:\VDF14.1.Dev\TITAN_MIGRATE\AppSrc\ExportDEOPNew3.vw
// ExportDEOPNew3
//
...
Activate_View Activate_ExportDeopNew3 for ExportDEOPNew3
Object ExportDEOPNew3 is a dbView
    Set Location to 4 9
    Set Size to 122 411
    Set Label to "Ñ•òö‡ö„ ÉÑéè (+ÑÂõ¶™ ©´¶ header)"
    ...
    Object Button5 is a Button
        ...
        Procedure OnClick
            ...
            While (Found)
                ...
                While ((Found) and (MIORDD.BTNORDH_RECR=MIORDH.RECR))
                    If (MIORDD.ITEM_TI_EINAI=1) Begin // Etoima Proionta Mono
                        Send Output_DEOP_Header MIORDD.VITEM MIORDD.VQTY MIORDD.VPRICE
                    End
        ...
        Procedure Output_DEOP_Header String asItem Number anQty Number anPrice
            ...
            Write   channel 9   '"'
            Write   channel 9   (Trim(asItem))  // '' // 111111111 (â‡õ†°Ê™ ë°¨®¶õ‚£ò´¶™)
            Write   channel 9   '"'
