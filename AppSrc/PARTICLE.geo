...
//AB/     AppBuild VIEW
    ...
    Object Particle is a dbViewSub
        ...
        Procedure Frontise_Ta_Ekkremh Integer aiEkleise
        ...
        Object Particle_DD is a Particle_DataDictionary
            ...
            Procedure Request_Delete
                Integer iErr isClosed isPrinted isReadOnly
                    ...
                    Get Read_Only_State to isReadOnly
                    If (isReadOnly) Begin
                        If (Not(isPrinted)) Begin
                            Begin_Transaction
                                Set Read_Only_state To False
                                Send Frontise_Ta_Ekkremh (isClosed)
        ...
        Object Particle_Partl_Hmnia is a dbFormSub
            ...
            Procedure Refresh Integer iMode
                ...
                If (iLockMe) Begin
                    ...
                    If (Particle.Partl_Ekleise='1') Set Label   Of BtnKleisimo to 'Ä§¶†ö£ò'
                    Else                            Set Label   Of BtnKleisimo to 'â¢úÂ©†£¶'
        ...
        Object dbTabDialogSub1 is a dbTabDialogSub
            ...
            Object TP______ is a dbTabPageSub
                ...
                If (Particle.Recnum) Begin
                    ...
                    If (Particle.Partl_No<0) Begin
                        ...
                        If (Found=1) Begin
                            ...
                            Unlock
                        End
                        Set Field_Changed_Value Of (Particle_DD(Self)) Field Particle.Partl_Ektyposh to '1'
        ...
        Procedure Activate_View Returns Integer
            ...
            Case Begin
                Case (psModule(Self)='01') // è‡¢„©ú†™ / èú¢·´ú™
                    ...
                    Set Label Of Particle to ("è‡¢„©ú†™ - â†§„©ú†™    " + sDescr)
                  Case Break
                Case (psModule(Self)='02') // è®¶£ûüú¨´‚™ / Äö¶®‚™
                    Send Rebuild_Constraints to Ptyppar_DD
                    Set Label Of Particle to ("Äö¶®‚™ - â†§„©ú†™    " + sDescr)
                  Case Break
            Case End
