//AB/ Project gefyresdom:domikh3
//AB/ Object prj is a View_Project
//AB/     Set ProjectName to "gefyresdom:domikh3"
//AB/     Set ProjectFileName to "gefyres3.vw"

// Project Object Structure
//   Gefyres3 is a dbViewSubS
...
ACTIVATE_VIEW Activate_Gefyres3 FOR Gefyres3

Object Gefyres3 is a dbViewSubS
    ...
    Set Label to "ƒ£ ¦¬¨ε „¨­ι¤ €§¦¨­ª 2 “§¦Ά¦ § §Ά«ΰ¤ 31-05-2008 Ermhs (Yannis Parasxos)"
    Set Size to 119 458
    Set Location to 9 7
    ...
    Object frmFileName is a FormSub
        ...
        Set Value Item 0 to "C:\B2_YPOLOIPA_PELATVN_31_05-2008.txt"
    ...
    Object ButtonSub1 is a ButtonSub
        ...
        Procedure OnClick
            ...
            If (syscurxr.branch_code<>'84') Begin
                Send Stop_Box '„„ € ’„„ ‘’ “‰€’€‘’†‹€ 84 - TRANS ƒ‹‰† “‰ 2 . „.' '‘­αΆ£ 7001'
                Procedure_Return
            End
            ...
            Direct_Output Channel 9 'C:\Ypoloipa_Trans_Error_31-05.txt'
        ...
        Procedure Read_Kinhseis String asFile String asBr
            ...
            Local String  sepon spol  sxre spis  s1 s2
            ...
            Append_Output Channel 9 'C:\Ypoloipa_Trans_Error_31-05.txt'
            ...
            Begin_Transaction
                ...
                Readln Channel 1 sCode s1 s2 nPoso
                ...
                While (not(Seqeof))
                    ...
                    If (nPoso<>0) Begin
                        ...
                        If (nPoso>0)        Move 101 To ictypkin
                        Else If (nPoso<0)   Move 102 To ictypkin
                        Else Goto Read_Next_Kinhsh34
                        Move (Trim(sCode))  To sCode
                        ...
                        If (sclientid="") Begin
                            Writeln Channel 9 '‰ ¤γ© ª - Record #' (String(iInt1)) '    Client not found codem= ' (Trim(scode)) '  Poso=' nPoso
                            Abort_Transaction
                            Goto Read_Next_Kinhsh34
                        End
                       ...
                       If (not(Found)) Begin
                        ...
                        Set Field_Changed_Value Of Cmoves_DD Field Cmoves.Cmoves_axia       To (Abs(nPoso))
                        ...
                        Set Field_Changed_Value Of Cmoves_DD Field Cmoves.Cmoves_A_Code     To '3'
